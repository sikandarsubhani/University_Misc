...
def write(a,b,c,driver):
    ...
    data = driver.find_element(by=By.CSS_SELECTOR, value='#page1-div > p:nth-child(4)')
    f.write("Dear, "+data.text + "\n")
    data = driver.find_element(by=By.CSS_SELECTOR, value='#page1-div > p:nth-child(164) > b')
    f.write("The amount of refrence id "+a+b+c+" is "+data.text + "\n")
    data = driver.find_element(by=By.CSS_SELECTOR, value='#page1-div > p:nth-child(201) > b')
    f.write("Due Date is : "+data.text + "\n")

    data = driver.find_element(by=By.CSS_SELECTOR, value='#page1-div > p:nth-child(164) > b')

    f.write("\nAmount\n Within Due Date : "+data.text + "\n")
    data = driver.find_element(by=By.CSS_SELECTOR, value='#page1-div > p:nth-child(197) > b')
